...
class ThreeAddressCodeGenerator(Equation):
    ...
    def generate(self):
        ...
        if(super().validate()==False):
            global label1            
            label1=Label(root,text="INVALID",font=("times",10),fg="white",bg="#0e2f44")
            label1.pack(pady=10)
        ...
        while(i<n):
            ...
            if(super().is_operator(e)):
                ...
                if e not in super().operators1:
                    ...
                    if(track==1):
                        global label2
                        label2=Label(root,text=ch+":="+top_ele+e+exp[i+1],font=("times",10),fg="white",bg="#0e2f44")
                        label2.pack(pady=10)
                        labels_list.append(label2)
                        
                    else:
                        global label3
                        label3=Label(root,text=ch+":="+prev_val+e+exp[i+1],font=("times",10),fg="white",bg="#0e2f44")
                        label3.pack(pady=10)
        ...
        while(tracker>-1):
            ...
            if(track1>1):
                global label4
                label4=Label(root,text=ch+":="+operand1+operator+prev_val,font=("times",10),fg="white",bg="#0e2f44")
                label4.pack(pady=10)
                ...
                global label5
                label5=Label(root,text=ch+":="+operand1+operator+operand2,font=("times",10),fg="white",bg="#0e2f44")
                label5.pack(pady=10)
...
label=Label(root,text="Enter expression",font=("times",20),fg="white",bg="#0e2f44")
label.pack(pady=50)
